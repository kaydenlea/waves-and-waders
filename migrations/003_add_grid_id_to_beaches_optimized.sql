...
-- This allows the map to display surf intensity colors based on grid data
...
-- Update comment
COMMENT ON VIEW beaches_optimized IS 'Optimized beaches view with pre-converted boolean flags and grid_id for surf intensity mapping.';
