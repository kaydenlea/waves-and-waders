...
const ToggleFilters = () => {
  ...
  return (
    <button
      ...
      className="relative shadow-lg rounded-full ring ring-border/70 p-4 border border-border/30 flex gap-2 items-center font-medium text-base dark:bg-highlight-5 dark:hover:bg-highlight-3 hover:bg-highlight-3 transition"
    >
