  ...
  return (
    <div className="h-screen @min-3xl:flex @min-3xl:flex-col">
      ...
      <main className="@min-3xl:flex @min-3xl:flex-1 overflow-hidden">
        ...
        <article className="bg-background w-full absolute px-2 @min-3xl:relative @min-3xl:pt-4 @min-3xl:flex-1 @min-3xl:translate-y-0 bottom-0 z-1 translate-y-[95%] rounded-t-3xl @min-3xl:rounded-t-none overflow-y-auto">
