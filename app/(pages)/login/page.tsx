    ...
    <main className="relative isolate min-h-[100svh] supports-[height:100dvh]:min-h-[100dvh] overflow-x-hidden">
      ...
      <div className="relative flex min-h-[100svh] flex-col supports-[height:100dvh]:min-h-[100dvh] lg:grid lg:grid-cols-2 lg:grid-rows-1">
        ...
        <section className="relative flex flex-1 min-h-0 flex-col items-stretch px-0 pb-0 pt-0 lg:min-h-[100svh] lg:items-center lg:justify-center lg:px-14 lg:py-16">
          ...
          />
          <AuthForm
            className="flex-1 min-h-0 w-full max-w-none mx-0 rounded-t-[2.75rem] rounded-b-none border border-white/12 bg-background/95 shadow-[0_-22px_80px_rgba(2,6,23,0.22)] supports-[backdrop-filter]:bg-background/85 supports-[backdrop-filter]:backdrop-blur-md sm:rounded-t-[2.75rem] dark:border-white/10 dark:bg-background/70 lg:flex-none lg:h-auto lg:max-w-md lg:rounded-[2rem] lg:border lg:border-border/60 lg:bg-background/90 lg:shadow-[0_24px_70px_rgba(2,6,23,0.12)] lg:supports-[backdrop-filter]:bg-background/70 lg:supports-[backdrop-filter]:backdrop-blur-xl lg:dark:bg-background/40 lg:dark:border-border/60 lg:dark:shadow-[0_24px_70px_rgba(0,0,0,0.35)]"
            footer={
